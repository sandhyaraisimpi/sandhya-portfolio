...
import { categories } from '../../data/project'
const Skills = () => {
    // categorize skills
    ...
    <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <FadeIn delay={100}>
             <div className='text-center mb-16'>
                    ...
                    <p className=' mb-4 text-lg text-white/60 max-w-xl mx-auto'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
                 ...
                 <FadeIn key={category} delay={categoryIndex*100}>
                    <div className='relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 group'> 
                        ...
                        {/* <div className='absolute inset-0 bg-linear-t0-br from-primary/0 to-primary/5 group-hover:from-primary/5 group-hover:to-primary/5 rounded-2xl transition-all duration-300 pointer-events-none'> */}
