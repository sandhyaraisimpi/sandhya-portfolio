               ...
               <div className=' absolute bottom-4 right-4 flex items-center gap-3'>
                    {demoUrl && (
                       <a 
                             ...
                             className='p-2.5 bg-white/10 backdrop-blur-md rounded-lg border border-white/20  hover:bg-primary/30  hover:border-primary/50 tranisition-all duration-300 hover:scale-110'
                             title='view Demo'
                       >
         ...
         <div className='p-6 space-y-4'>
             ...
             <div className='flex flex-wrap gap-2'>
               {technologies.map((tech, index)=>(
                    <span 
                        key={index}
                        className='px-3 py-1 text-xs font-medium text-primary bg-black/10 backdrop-blur-sm  border border-primary/10 rounded-lg hover:bg-primary/20 transition-colors duration-200'
                    >
                        {tech}
                    </span>
               ))}
