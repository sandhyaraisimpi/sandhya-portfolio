...
const Skills = [
 ...
 { name: 'GitHub', icon: SiGithub },
  ...
  return <section id="about" className='relative py-20 bg-black overflow-hidden'>
                                         ...
                                         <div className='flex items-start gap-4'>
                                            ...
                                            <div className='flex-1'>
                                                ...
                                                <p className='text-sm text-white/70 leading-relaxed'> 
                                                     Specialized in building scalable web application with modern technogies and best practice
                                                </p> */}
                                                <p className='text-sm text-white/70 leading-relaxed'>
   Passionate about Software Development, scalable Full Stack
   Applications, and AI-driven research with a focus on performance,
   usability, and clean architecture.
                             ...
                             <div className='relative group'>
                                ...
                                <div className='relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full'>
                                     ...
                                     <p className='text-sm text-white/70 leading-relaxed'>
   Developing clean, maintainable, and scalable software with a strong focus on code quality, performance, and best practices.
</p>
                                </div>
                             </div>
                                 <div className='relative group'>
                                    <div className='absolute inset-0 bg-linear-to-br from-primary/10 to-primary/5 rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-300'></div>
                                        <div className='relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full'>
                                            ...
                                            <p className='text-sm text-white/70 leading-relaxed'>
   Building high-performance applications focused on speed, scalability, and exceptional user experience.
</p>
                                        </div>
                                    </div>  
                                       ...
                                       <div className='relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300'>
                                            <div className='grid grid-cols-3 gap-6 text-center'>
                                                ...
                                                <div>
                                                     ...
                                                     <div className='text-xs text-white/60'> Suppor Available</div>
                                                </div>
                                                  <div>
   ...
   <div className='text-xs text-white/60'>Major Projects</div>
</div>

<div>
   <div className='text-2xl font-bold text-primary mb-1'>1</div>
   <div className='text-xs text-white/60'>Research Project</div>
</div>

<div>
   <div className='text-2xl font-bold text-primary mb-1'>3</div>
   <div className='text-xs text-white/60'>Internship</div>
</div>
                                              </div>
                                       </div>
...
<p className='text-sm text-white/60'>
  Technologies and tools I use to build scalable software and AI-driven solutions.
</p>
                    </div>
                    <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 w-full max-w-4xl'>
                        {Skills.map((skill, index)=>(
                           ...
                           >   
                              ...
                              {/* hover glow effect */}
                              <div className='absoluteinset-0 bg-linear-to-br from-primary/0 to-primary/0 group-hover:from-primary/10 group-hover:to-primary/10  rounded-2xl transition-all duration-300'></div>
                           </div> 
                        ))}
                    </div>
                </div>
