...
import { Mail, MapPin, Github, Linkedin, Twitter, Dribbble, Heart, Import } from 'lucide-react';
  ...
  return (
   ...
   <footer className="relative bg-black overflow-hidden border-t border-white/10 ">
        <div className="absolute inset-0 overflow-hidden">
            ...
            <div className="absolute top-0 right-1/4 w-96 h-96 bg-primary/10 opacity-30 rounded-full blur-3xl" />
        </div>
                ...
                <h3 className="text-3xl font-bold bg-linear-to-r from-primary/80 via-primary to-primary/80 bg-clip-text text-transparent mb-4 ">
                  ...
                  <div className="space-y-3">
                       <a 
                          ...
                          className="group flex items-center gap-3 p-3 bg-white/5 border border-white/10 rounded-xl Ohover:bg-white/10 hover:border-primary/30 transition-all duration-300"
                       >
                          <div className="p-2 bg-primary/10 rounded-lg">
                              <Mail className="w-4 h-4 text-primary" />
                          </div>
                          <span className="text-pink-700 text-sm group-hover:text-pink-700 transition-colors">
                               {PERSONAL_INFO.email}
                          </span>
                        </a>
                  ...
                  {NAV_LINKS.map((link) => (
                      <li key={link. id}>
                       <button
                        ...
                        >
                            <div className="w-1.5 h-1.5 rounded-full bg-white/30 group-hover:bg-primary group-hover:w-2 transiotion-all duration-300" />
             ...
             <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                <p className="text-white/50 text-sm">
                 ...
                 <p className="flex items-center gap-2 text-white/50 text-sm">
                     Built with <Heart className="w-4 h-4 text-primary fill-primary animate-pulse" /> using React & TailwindCSS
                  </p>
              </div>
          </div>
        </FadeIn>
