  ...
  return (
   <section id="contact" className="relative py-20 bg-black overflow-hidden">
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute top-1/4 right-0 w-96 h-96 bg-primary/20 opacity-30 rounded-full blur-3xl" />
                ...
                <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
                             ...
                             <label htmlFor="name" className="block text-sm font-medium text-white/80 mb-2">
                              ...
                              <input
                                 type="text"
                                  ...
                                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none focus:rang-2 focus:rang-primary/50 focus:border-primary/50 transition-all duration-300"
                          ...
                          <div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    rows={5}
                                     className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none focus:rang-2 focus:rang-primary/50 focus:border-primary/50 transition-all duration-300 resize-none"
                                    placeholder="Tell me about your proje.."
                                />
                            </div>
                                ...
                                {status.message && (
                                    < div
                                        className={`p-4 rounded-xl ${status.type ==='success'
                                           ? 'bg-green-500/10 border border-green-500/20 texr-green-400'
                  ...
                  <FadeIn delay={200}>
                    <div className='space-y-8'>
                        <div>
                            <h3 className='text-2xl font-semibold text-white mkb-4'>
                                Let's Connect
                            </h3>
                             <p className='text-white/60 leading-relaxed'>
                                  I'm always open to discussing new projects, creative ideas, or oppertunities to be part of your vision. Feel free to reach out!  
                             </p>
                        </div>
                        ...
                        <div className='space-y-4'>
                            <div className='group relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 '>
                                <div className='flex items-start gap-4'>
                                    <div className='p-3 bg-linear-to-br from-primary/2o to-primary20 border border-primary/30 rounded-xl'>
                                ...
                                {Object.entries(SOCIAL_LINKS).slice(0,3).map(([platform, url])=>{
                                    ...
                                    return Icon ? (
                                        <a 
                                           ...
                                           className='p-4 bg-white/5 rounded-xl border border-white/10 hover:gb-white/10 hover:border-primary/50 hover:scale-110 transition-all duration-300 group'
                                        >
